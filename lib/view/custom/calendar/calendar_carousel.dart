...
//  DateTime currentPageTime;
  ...
  void initState() {
    ...
    _monthRatio = _calendarUtil.getAspectRatio(widget.currentPageTime,
        show: CalendarShow.CalendarShowMonth);
    _weekRatio = _calendarUtil.getAspectRatio(widget.currentPageTime,
        show: CalendarShow.CalendarShowWeek);
...
//  }
  ...
  Widget _calendarDayWidget() {
    double shrinRatio = ScreenUtil().screenWidth /
        (ScreenUtil().screenWidth / _monthRatio - widget.shrinkageHeight);
...
//    });
  ...
  _setScrollPhysicMaxMin() {
    ...
    _scrollPhysics.status.minScrollExtent =
        ScreenUtil().screenWidth * _calendarUtil.indexOf(widget.startTime);
    _scrollPhysics.status.maxScrollExtent =
        ScreenUtil().screenWidth * _calendarUtil.indexOf(widget.endTime);
  }
