...
class _MonthWeekCalendarState extends State<MonthWeekCalendar>
  ...
  void initState() {
    ...
    Provider.of<MedicHistoryProvider>(context, listen: false)
        .setSecondInitDate(DateTime(2020, 9, 1));
  }
      ...
      children: <Widget>[
        ...
        Consumer<MedicHistoryProvider>(
          ...
          return CalendarCarousel(
            ...
            weekdayHeader: CalendarWeekday(7, 30, builder: (int weekday) {
              return Container(
                child: Text(
                  weekList[weekday - 1],
                  style: TextStyle(
                  ...
                  children: <Widget>[
                    Container(
                        margin: EdgeInsets.only(
                            top: (MediaQuery.of(context).size.width / 7 - 10) /
                                4),
                        width: (MediaQuery.of(context).size.width / 7 - 10) / 2,
                        height:
                            (MediaQuery.of(context).size.width / 7 - 10) / 2,
                        child: Center(
                          child: Text(
      ...
      children: <Widget>[
        ...
        FlatButton(
            ...
            onPressed: () {
              ...
              setState(() {});
              _calendarController.changeCalendarShow(
                  _show,
                  Provider.of<MedicHistoryProvider>(context, listen: false)
                      .secondCurrentPageTime);
            }),
